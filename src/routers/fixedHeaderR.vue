<template>
  <div style="margin: 20px">
    ...
    <BeeGridTable :border="true" height="560" :showSummary="false" :columns="columns" :data="data">
...
export default {
    ...
    columns: [
        ...
        { title: "순번", key: "peopleCode", width: 150, resizable: true },
        { title: "성명", key: "idNumber", width: 150,fixed: "right", resizable: true },
        {
          title: "편집",
          slot: "op",
          headSlot: "hop",
