<template>
  <table cellspacing="0" cellpadding="0" border="0" :style="styles">
    <colgroup>
      <col v-for="(column, colindex) in columns" :width="setCellWidth(column)" :key="colindex" />
            ...
            <div :class="cellClasses(column)">
              ...
              <template v-else>
                ...
                <render-header
                  ...
                  :index="index"
                ></render-header>
                <table-head-slot v-else-if="column.headSlot" :column="column" :index="index"></table-head-slot>
      ...
      <tr v-if="showFilter" :class="filterRowClasses()">
        ...
        >
          <div class="th-filter-content">
            <div :class="filterCellClasses(fcolumn)" v-if="fcolumn.hideFilter"></div>
            <div :class="filterCellClasses(fcolumn)" v-if="!fcolumn.hideFilter">
              ...
              <template v-else-if="fcolumn.headFilterSlot">
                <table-head-filter-slot :column="fcolumn" :index="hrowIndex"></table-head-filter-slot>
              </template>
            </div>
          </div>
        </td>
...
import DatePicker from '../date-picker/picker.vue';
