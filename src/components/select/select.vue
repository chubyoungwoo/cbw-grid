...
export default {
    ...
    computed: {
        ...
        dropdownCls() {
            return {
                ...
                ['bee-auto-complete']: this.autoComplete,
        ...
        showCreateItem() {
            ...
            if (this.allowCreate && this.query !== '') {
                ...
                if ($options && $options.length) {
                    if ($options.find(item => item.showLabel === this.query))
                        state = false;
                }
            }
            return state;
        ...
        navigateOptions(direction) {
            ...
            if (direction > 0) {
                ...
                for (let i = 0; i < this.flatOptions.length; i++) {
                    const optionIsActive = !this.flatOptions[i].componentOptions
                        .propsData.disabled;
    ...
    watch: {
        ...
        focusIndex(index) {
            ...
            const optionValue = this.flatOptions[index].componentOptions
                .propsData.value;
