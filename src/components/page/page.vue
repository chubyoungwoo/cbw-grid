<template>
  <ul :class="simpleWrapClasses" :style="styles" v-if="simple">
    <li :title="t('i.page.prev')" :class="prevClasses" @click="prev">
      <a>
        <i class="bee-sys-icon ios-arrow-back"></i>
      </a>
    </li>
    ...
    <li :title="t('i.page.next')" :class="nextClasses" @click="next">
      <a>
        <i class="bee-sys-icon ios-arrow-forward"></i>
      </a>
    </li>
  </ul>
  <ul :class="wrapClasses" :style="styles" v-else>
    ...
    <li :title="t('i.page.prev')" :class="prevClasses" @click="prev">
      <a>
        ...
        <i v-else class="bee-sys-icon ios-arrow-back"></i>
      </a>
    </li>
    ...
    <li :title="t('i.page.next')" :class="nextClasses" @click="next">
      <a>
        ...
        <i v-else class="bee-sys-icon ios-arrow-forward"></i>
      </a>
    </li>
    <Options
    ...
    computed: {
        ...
        allPages() {
            const allPage = Math.ceil(
                this.filterTotalData / this.currentPageSize
            );
